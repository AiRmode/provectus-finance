...
//        importService.importTaxRecordFile(new File(getClass().getClassLoader().getResource("UkrSib_USD_2603.pdf").getFile()), "asd");
//        importService.importTaxRecordFile(new File(getClass().getClassLoader().getResource("testUAH2600.xls").getFile()), "asd");
    }
}
